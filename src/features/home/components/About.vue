...
import BoxInterests from "./BoxInterests.vue";
...
const contentInterestsRef = ref<HTMLDivElement | null>(null);
...
const tlInterestsRef = ref<gsap.core.Timeline | null>(null);
...
watchEffect((onInvalidate) => {
  if (
    ...
    tlDetailsRef.value &&
    contentInterestsRef.value &&
    tlInterestsRef.value &&
    ...
    transitions.about.setup({
      ...
      contentInterests: contentInterestsRef.value,
      tlInterests: tlInterestsRef.value,
...
<template>
  <div class="about-content">
    ...
    <div ref="contentInterestsRef" class="about-interests">
      <BoxInterests @timeline:created="(tl: gsap.core.Timeline) => (tlInterestsRef = tl)" />
    </div>
